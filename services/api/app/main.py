...
from app.api.v1 import companies, auth, sync, dashboard, analytics, views, connectors, users, infomanager_ops
...
app.include_router(infomanager_ops.router, prefix="/api/v1", tags=["infomanager-ops"])
