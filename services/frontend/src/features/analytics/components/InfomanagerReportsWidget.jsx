...
export const INFOMANAGER_REPORT_GROUPS = {
  clientes: [
    ...
    { label: 'Cuenta Corriente de Cliente', reportKey: 'saldos_clientes' },
    ...
    { label: 'Listado de Notas de Credito', reportKey: 'facturas_clientes' },
    { label: 'Listado de Notas de Debito', reportKey: 'facturas_clientes' },
    { label: 'Exportacion Ingresos Brutos', reportKey: 'iva_balance' },
    { label: 'Percepciones de Ingresos Brutos', reportKey: 'iva_balance' },
    { label: 'Margen de Rentabilidad', reportKey: 'ventas_items' },
    { label: 'Margen Bruto Mensual', reportKey: 'ventas_items' },
  ],
  proveedores: [
    { label: 'Saldos de Cuentas Corrientes de Proveedores', reportKey: 'facturas_compras' },
    { label: 'Cuenta Corriente de Proveedor', reportKey: 'facturas_compras' },
    { label: 'Anticipos Emitidos vs Cancelados', reportKey: 'anticipos_proveedores' },
    { label: 'Gastos por Rubro de Proveedores', reportKey: 'compras_items' },
    { label: 'Comprobantes Pendientes Totales', reportKey: 'facturas_compras' },
    { label: 'Comprobantes Pendientes por Proveedor', reportKey: 'facturas_compras' },
    { label: 'Remitos vs Facturas', reportKey: 'comprobantes_relacion' },
    { label: 'Facturas vs Remitos por Totales de Articulos', reportKey: 'compras_items' },
  ...
  caja: [
    ...
    { label: 'Cash Flow', reportKey: 'cheques' },
  ],
  contabilidad: [
    { label: 'IVA Compras', reportKey: 'iva_balance' },
    { label: 'IVA Ventas', reportKey: 'iva_balance' },
    ...
    { label: 'Estado de Resultados', reportKey: 'iva_balance' },
  ...
  vendedores: [
    { label: 'Ventas por Vendedor', reportKey: 'ventas' },
