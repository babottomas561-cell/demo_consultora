...
const PROVEEDORES_WIDGET_CATALOG = [
  ...
  { type: 'p-infomanager-reportes', name: 'Informes InfoManager', description: 'Reportes originales de proveedores exportables a Excel', icon: Database, component: createInfomanagerReportsWidget(INFOMANAGER_REPORT_GROUPS.proveedores), defaultSize: { w: 12, h: 7 }, category: 'table' },
];
...
export const PROVEEDORES_DEFAULT_WIDGETS = [
  ...
  { id: 'p-14', type: 'p-infomanager-reportes' },
];
...
export const PROVEEDORES_DEFAULT_LAYOUTS = {
  lg: [
    ...
    { i: 'p-9',  x: 0,  y: 4,  w: 12, h: 7, minW: 6, minH: 4 },
    ...
    { i: 'p-14', x: 0,  y: 31, w: 12, h: 7, minW: 6, minH: 4 },
  ],
  md: [
    { i: 'p-1',  x: 0,  y: 0,  w: 3,  h: 2, minW: 2, minH: 2 },
    { i: 'p-2',  x: 3,  y: 0,  w: 3,  h: 2, minW: 2, minH: 2 },
  ...
  sm: [
    ...
    { i: 'p-9',  x: 0, y: 8,  w: 6, h: 7, minW: 3, minH: 4 },
    ...
    { i: 'p-14', x: 0, y: 41, w: 6, h: 7, minW: 3, minH: 4 },
  ],
};
